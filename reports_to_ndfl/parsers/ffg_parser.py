...
class FFGParser(BaseBrokerParser):
    def process(self):
        ...
        if len(result) == 11:
            # New format with dividends_by_currency and other_commissions_by_currency
            ...
            return result[:8] + (profit_by_income_code, profit_by_income_code_currencies, dividends_by_currency, other_commissions_by_currency)
